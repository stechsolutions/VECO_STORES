    ...
    <Screen style={{backgroundColor: colors.light}}>
      <ScrollView style={{flex: 1, padding: 10}}>
        <View style={styles.subContainer}>
          <AppText style={styles.title}>Assign Dispatcher</AppText>
        ...
        <View style={styles.subContainer}>
          <AppText style={styles.title}>Set Delivery Date</AppText>
        ...
        <AppButton
          onPress={assignDispatcher}
          style={styles.assignButton}
          title="ASSIGN"
        />
        <View>
          <AppText style={styles.title}>Assigned Dispatchers</AppText>
          {assignedDispatchers && assignedDispatchers.length ? (
            assignedDispatchers.map((item) => (
              <AppChat
                key={item.dispatcherId}
                title={item.name}
                image={
                  item.image ? item.image : require('../../assets/user.jpg')
                }
                btnText="Details"
