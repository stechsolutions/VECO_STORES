      ...
      <ScrollView style={{flex: 1}}>
        ...
        <View style={styles.productsHead}>
          <View style={styles.head1}>
            <AppText style={styles.boldText}>Products</AppText>
            <AppText style={styles.greyText}>
              Add, update and delete products
            </AppText>
          </View>
          <View style={styles.head2}>
            <AppText style={styles.boldText}>Best Sellers</AppText>
        ...
        <View style={styles.products}>
            ...
            products.map((product, i) => {
              return (
                <AppChat
                  ...
                  onPress={() =>
                    navigation.navigate('editProduct', {product, deleteProduct})
                  }
                  onEdit={() =>
                    navigation.navigate('editProduct', {product, deleteProduct})
                  }
          ...
          {!products.length && (
            <AppText style={styles.noProducts}>No Products</AppText>
          )}
        </View>
      </ScrollView>
    </Screen>
