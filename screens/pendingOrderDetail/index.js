  ...
  return (
    <Screen style={{backgroundColor: colors.light}}>
      <ScrollView style={{flex: 1}}>
        <View style={{flex: 1}}>
          <AppText style={styles.orderDetailText}>Status: Arrived</AppText>
        </View>
        <View style={{flex: 1}}>
        ...
        <View style={styles.item}>
          ...
          <View style={styles.prodList}>
            <View style={styles.productItemView}>
              ...
              <AppText style={styles.qty}>1x</AppText>
        ...
        <View style={{margin: 10}}>
          <Text>
            <AppText style={styles.padding}>Payment Method</AppText> : VISA
          </Text>
        </View>
        <View style={{flex: 1}}>
        ...
        <View>
          <TextInput
            placeholder={IMLocalized('Write Here')}
            multiline
            numberOfLines={7}
