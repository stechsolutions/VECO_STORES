        ...
        <Screen style={{ backgroundColor: colors.light }}>
            <ScrollView style={{ flex: 1, }}>
                <View style={styles.statusView}>
                    ...
                    <View style={styles.status}>
                        <View style={styles.circle} />
                        <Text style={styles.statusText}>Shipped by dealer (27/Feb/2021)</Text>
                    </View>
                    <View style={styles.yellowBar} />
                    <View style={styles.status}>
                        {/* <View style={styles.circle} /> */}
                        <FontAwesome style={{ marginHorizontal: 15, }} name='arrow-circle-right' color={colors.secondary} size={50} />
                        <Text style={[styles.statusText, { fontWeight: 'bold', color: 'black' }]}>Arrived - Ended Proces (28/Feb/2021)</Text>
                    </View>
                </View>
                ...
                <View style={[styles.btnView, { padding: 20, }]}>
                    <Text style={{ fontSize: 18, fontWeight: '700', color: '#333333' }}>How about your Delivery?</Text>
                </View>
                ...
                <View style={[styles.btnView, { flexDirection: 'row', justifyContent: 'flex-end', marginHorizontal: 20,marginVertical:20, }]}>
                    <AppButton
...
const styles = StyleSheet.create({
    ...
    ratingView: {
        ...
        borderBottomWidth: 1, marginHorizontal: 20, marginVertical: 10,
    },
    ratingLabel: {
        flex: 0.5,
