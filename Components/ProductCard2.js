...
export default function ProductCard2({ navigation, color, onPress, image, price }) {
...
const styles = StyleSheet.create({
    ...
    image: {
        width: '100%', height: '100%', resizeMode: 'cover', borderRadius: 20,
    },
    detailView: {
        justifyContent: 'flex-end', alignItems: 'flex-end',
         borderRadius: 20,flex:1,flexDirection:'row',margin:5,
    },
    whiteText: {
        color: 'white',
        fontSize: 18,
