...
const UpdateStoreStack = () => (
  <Stack.Navigator screenOptions={{ headerTitleAlign: 'center' }}>
    ...
    <Stack.Screen
      ...
      options={({ navigation }) => ({
        headerLeft: () => (
          <Ionicons name="arrow-back-outline" size={25} onPress={() => navigation.goBack()} />
        ),
        headerLeftContainerStyle: {
          paddingLeft: 15,
        },
...
const PurchaseOrdersStack = () => (
  <Stack.Navigator screenOptions={{ headerTitleAlign: 'center' }}>
    ...
    <Stack.Screen
      name="searchProducts"
      component={SearchProductsStack}
      options={{ headerShown: false }}
    />
    <Stack.Screen options={{ title: 'Pending Orders' }} name="pendingOrders" component={PendingOrders} />
    <Stack.Screen options={{ title: 'Order Status' }} name="pendingOrderDetail" component={PendingOrderDetail} />
    <Stack.Screen options={{ title: 'Complete Reception' }} name="completeReception" component={CompleteReception} />
    <Stack.Screen options={{ title: 'Credit Notes' }} name="creditNotes" component={CreditNotes} />
    <Stack.Screen options={{ title: 'Credit Note Details' }} name="creditNoteDetail" component={CreditNoteDetail} />

    <Stack.Screen options={{ title: 'Make Deposit' }} name="makeDeposit" component={MakeDeposit} />
    <Stack.Screen
...
const StatStack = () => (
  <Stack.Navigator screenOptions={{ headerTitleAlign: 'center' }}>
    ...
    <Stack.Screen name="StoreAndDetails" component={StoreAndDetails} options={{ title: 'Store And Details' }} />
    <Stack.Screen
      name="My Dealers"
  ...
  <Stack.Navigator Navigator screenOptions={{ headerTitleAlign: 'center' }}>
    <Stack.Screen
      ...
      options={({ navigation }) => ({
        ...
        headerRight: () => (
          <CartIcon onPress={() => navigation.navigate('CheckOut')} items={count || 0} />
        ),
        headerLeftContainerStyle: {
          paddingLeft: 15,
        },
    ...
    >
      {(props) => <SearchProducts {...props} cartCount={count} setCartCount={setCount} />}
    </Stack.Screen>
    <Stack.Screen
    ...
    >
      {props => <ProductDetail {...props} cartCount={count} setCartCount={setCount} />}
    </Stack.Screen>
    <Stack.Screen
      name="CheckOut"
      // component={CheckOut}
    ...
    >
      {props => <CheckOut {...props} cartCount={count} setCartCount={setCount} />}
    </Stack.Screen>
    <Stack.Screen
      name="PaymentMethods"
    ...
    <Stack.Screen
      ...
      options={({ navigation }) => ({
        headerLeft: () => (
          <Ionicons name="arrow-back-outline" size={25} onPress={() => navigation.navigate('SearchProductStack')} />
        ),
      }), {
        title: 'Order Completed',
      }}
    >
      {props => <OrderCompletion {...props} cartCount={count} setCartCount={setCount} />}
    </Stack.Screen>
  ...
  return (
    <Stack.Navigator screenOptions={{ headerTitleAlign: 'center' }}>
      ...
      <Stack.Screen
        ...
        options={{ headerShown: false }}
      >
        {(props) => <SearchProductsStack {...props} count={count}
